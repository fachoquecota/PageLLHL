<template>
       ...
       v-model="drawer"
        ...
        <v-list>
          ...
          <v-list-item :to="{path: '/'}">
           ...
           <v-list-item :to="{path: '/listarLogCheat'}">
            <v-list-item-action>
              <v-icon>mdi-{{ icons[1] }}</v-icon>
            </v-list-item-action>
            <v-list-item-content>
              <v-list-item-title>Listar Cheats</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
      ...
      <v-app-bar-nav-icon @click="drawer=true" class="white--text"></v-app-bar-nav-icon>
        ...
        <v-img
          ...
          class="shrink mr-2"
          contain
          src="https://raw.githubusercontent.com/FlyingCat-X/llhl/master/LLHL_logo.png"
